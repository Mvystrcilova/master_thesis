...
\begin{enumerate}
    \item Gradients of networks which are \textbf{trained and validated on full data} are displayed in Figure~\ref{shifted-gradients-different-architecture}.
...
\todo{summarize performance with gradients, point out interesting things}
