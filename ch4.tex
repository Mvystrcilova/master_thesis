...
Gradients of all intermediate layers and the visualizations can be found in the Appendix \todo{add apendix}.
...
The complete results can be found in Appendix\todo{add appendix}.
...
The results for all layers can be found in Appendix\todo{add appendix}.}, we observe that the networks indeed use modulations in the high-gamma frequency bands for their predictions. 
